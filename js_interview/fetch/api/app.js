...
let jokes = [
  ...
  {
    id: 4,
    joke: "Programming is 1% writing code and 99% understanding why it's not working",
  },
  { id: 5, joke: "I told him I could not open a jar. He told me to download Java" },
  {
    id: 6,
    joke: "Comparing Java and JavaScript is the same as comparing a car and carpet",
  },
...
app.post("/jokes-post", (req, res) => {
  if (!req.body.joke) {
    res
      .status(400)
      .json({ error: "Bad Request - Please provide a joke in the request body" }); // 400 Bad Request
  } else {
